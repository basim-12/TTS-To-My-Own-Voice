...
def main():
    ...
    if uploaded_file:
        ...
        if os.path.exists(output_speech) and voice_sample:
            ...
            if os.path.exists(converted_speech):
                ...
                if st.button("Regenerate Converted Speech"):
                    output = convert_to_user_voice(voice_sample, output_speech, converted_speech)
